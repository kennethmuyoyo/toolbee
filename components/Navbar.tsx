    ...
    <nav className="pt-6 px-5 md:px-16 pb-6 fixed w-full z-30 top-0 bg-custom-purple">
      <div className="max-w-screen-xl mx-auto flex flex-wrap items-center justify-between">
        ...
        <div className="flex md:order-2">
          <a href="#featuresection" className="z-40 font-poppins font-medium text-black bg-custom-yellow hover:bg-yellow-600 rounded-lg px-4 py-2 text-center md:text-[14px] text-[13px]">Featured Tools</a>
